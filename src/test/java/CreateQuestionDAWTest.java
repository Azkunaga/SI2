...
public class CreateQuestionDAWTest {
	...
	public void test1() {
		try {
			...
			testDA.open();
			ev = testDA.addEventWithQuestion(eventText, oneDate, queryText, betMinimum, kirola, txapelketa);
			testDA.close();
	...
	public void test2() {
		try {
			...
			// configure the state of the system (create object in the dabatase)
			testDA.open();
			ev = testDA.addEventWithQuestion(eventText, oneDate, "query2", betMinimum, txapelketa, kirola);
			testDA.close();
