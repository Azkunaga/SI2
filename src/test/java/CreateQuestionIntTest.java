...
public class CreateQuestionIntTest {
	...
	public void test1() {
		try {
			...
			ev = testBL.addEventWithQuestion(eventText,oneDate,queryText,betMinimum, kirola,txapelketa );
	...
	public void test2() {
		try {
			...
			//configure the state of the system (create object in the dabatase)
			ev = testBL.addEventWithQuestion(eventText,oneDate,"query2",betMinimum,kirola,txapelketa);
