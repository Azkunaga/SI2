...
public class EmaitzakIpiniDAB2Test {
	...
	public void test1() {
		try {
			...
			q.setResult(p);
			testDA.createQuestion(null, "Zenbat gol?", (float)2);
			testDA.createPronostikoa("2 Gol", (float)0.4, q);
	...
	public void test2() {
		...
		try {
			...
			testDA.createQuestion(null, "Zenbat gol?", (float)2);
			testDA.createPronostikoa("2 Gol", (float)0.4, null);
			testDA.close();
	...
	// pronostikoa null denean
		...
		public void test4() {
			try {
				...
				testDA.open();
				testDA.createQuestion(e, "Zenbat gol?", 2);
				testDA.createPronostikoa("2 Gol", (float)0.3, q);
				testDA.close();
	...
	public void test5() {
		...
		try {
			...
			pros.addElement(pEzIrabazi);
			Apustua ap = new Apustua((float)3,pros,b,b,30);
			testDA.apustuaEgin(pros, 2, b, b, (float)0.3);
			testDA.createPronostikoa("Zenbat gol?",(float) 2, q);
			testDA.close();
